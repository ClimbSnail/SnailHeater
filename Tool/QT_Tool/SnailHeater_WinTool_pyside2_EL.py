...
# python -m venv pyside2_venv
# pyside2_venv\Scripts\activate
# deactivate
# pip install -r requirements_pyside2_venv.txt -i https://mirrors.aliyun.com/pypi/simple/
# pip freeze > requirements_pyside2_venv.txt
# pyinstaller --icon ./images/SnailHeater_256.ico -w -F SnailHeater_WinTool_pyside2_EL.py
...
def main():
    ...
    if ui_file.open(QIODevice.ReadOnly):
        ...
        if download_ui is not None:
            ...
            raise RuntimeError("Failed to load download.ui")
    else:
        raise RuntimeError("Unable to open download.ui")
