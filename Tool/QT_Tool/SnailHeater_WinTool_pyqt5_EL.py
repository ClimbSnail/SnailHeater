...
# python -m venv pyqt5_venv
# pyqt5_venv\Scripts\activate
# deactivate
# pip install -r requirements_pyqt5_venv.txt -i https://mirrors.aliyun.com/pypi/simple/
# pip freeze > requirements_pyqt5_venv.txt
# pyinstaller --icon ./images/SnailHeater_256.ico -w -F SnailHeater_WinTool_pyqt5_EL.py
