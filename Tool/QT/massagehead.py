...
class SettingMsg(MsgHead):
    ...
    def __init__(self, action_type=AT.AT_SETTING_GET):
        MsgHead.__init__(self, MT.MODULE_TYPE_DOWNLOADER_TOOL, MT.MODULE_TYPE_SH_SETTINGS, action_type)  # 一定要初始化父类
        # 以下数据直接使用空格隔开
        # self.prefs_name = b''
        self.key = b''
        self.type = b''
