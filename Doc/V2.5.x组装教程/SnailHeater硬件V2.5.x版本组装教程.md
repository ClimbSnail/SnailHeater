...
本教程对SnailHeater主机接线提供一个统一的接线规范。SnailHeater主机包含5款PCB板，分别为`内嵌板`、`屏幕板`、`核心板`、`接线拓展版`、`功率板`。本教程涉及的配件在此在线文档中均有购买连接推荐或者相关描述： https://docs.qq.com/sheet/DQUlDclNBWXhFbUdW
...
2. 屏幕板的`接线拓展板`与`功率板`的fpc规格为`fpc 6pin 6cm同向`，风扇供电使用`XH2.54 双头80mm 同向线`连接。
