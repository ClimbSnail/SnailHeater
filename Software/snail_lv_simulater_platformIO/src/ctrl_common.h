...
enum HEAT_PLATFORM_STATE : unsigned char
{
...
enum HP_HEATING_MODE : unsigned char
{
...
enum HP_AIR_MODE : unsigned char
{
    HP_AIR_MODE_NONE = 0,
...
enum HA_HEATING_MODE : unsigned char
{
...
enum HA_AIR_MODE : unsigned char
{
    AIR_MODE_NONE = 0,
    AIR_MODE_PWM,  // pwm空速
    AIR_MODE_FULL, // 全速控制
...
enum ADJ_POWER_OPEN_STATE : unsigned char
{
    ADJ_POWER_OPEN_STATE_CLOSE = 0, // 自动状态关闭
    ADJ_POWER_OPEN_STATE_OPEN,      // 自动状态开启
};

enum ADJ_POWER_MODE : unsigned char
{
...
enum SOLDER_SHAKE_TYPE : unsigned char
{
